...
//     private boolean preVisit[];
//     private int leftChangePage;
...
//         isUsed = new boolean[numPages];
//         preVisit = new boolean[numPages];
//         leftChangePage = numPages;
//     }
...
//         // some code goes here
//         // todo: not handling the lock and the premission!!
//         for (int i = 0; i < numPages; ++i){
//             if (isUsed[i] && pages[i].getId().equals(pid)){
//                 pinPage(i);
//                 return pages[i];
//             }
//         }
//         DbFile tmp;
//         try {
//             tmp = Database.getCatalog().getDatabaseFile(pid.getTableId());
//         }
...
//         }
//         evictPage();
//         pages[evictId] = tmp.readPage(pid);
//         isUsed[evictId] = true;
//         pinPage(evictId);
//         return pages[evictId];
//     }
...
//         // todo: be careful about this code
//         DbFile f = Database.getCatalog().getDatabaseFile(tableId);
//         ArrayList<Page> tmpList = f.insertTuple(tid, t);
//         for (Page writePage: tmpList){
//             writePage.markDirty(true, tid);
//         }
...
//             for (int i = 0; i < numPages; ++i){
//                 if (isUsed[i] && pages[i].getId().equals(writePage.getId())) {
//                     pages[i] = writePage;
//                     pinPage(i);
//                     inCache = true;
//                     break;
...
//         ArrayList<Page> tmpList = f.deleteTuple(tid, t);
//         for (Page writePage: tmpList){
//             writePage.markDirty(true, tid);
//         }
...
//         // not necessary for lab1
//         for (int i = 0; i < numPages; ++i){
//             if (isUsed[i] && pages[i].isDirty() != null){
...
//         // not necessary for lab1
//         for (int i = 0; i < numPages; ++i){
//             if (isUsed[i] && pages[i].getId().equals(pid) && pages[i].isDirty() != null){
...
//             evictId = rand.nextInt(numPages);
//             isUsed[evictId] = false;
//             if (pages[evictId].isDirty() != null) {
//                 pages[evictId].markDirty(false, null);
//                 Database.getCatalog().getDatabaseFile(pages[evictId].getId().getTableId()).writePage(pages[evictId]);
//             }
//         }
//         catch (Exception e){
//             throw new DbException("evcit page wrong!");
//         }*/
//         try {
//             Random rand = new Random();
//             if (leftChangePage > 0) {
//                 int changeOrder = rand.nextInt(leftChangePage);
//                 for (int i = 0; i < numPages; ++i) {
//                     if (!preVisit[i] && changeOrder == 0) {
//                         evictId = i;
//                         isUsed[evictId] = false;
//                         if (pages[evictId].isDirty() != null) {
//                             pages[evictId].markDirty(false, null);
...
//                 evictId = rand.nextInt(leftChangePage);
//                 isUsed[evictId] = false;
//                 if (pages[evictId].isDirty() != null) {
//                     pages[evictId].markDirty(false, null);
//                     Database.getCatalog().getDatabaseFile(pages[evictId].getId().getTableId()).writePage(pages[evictId]);
